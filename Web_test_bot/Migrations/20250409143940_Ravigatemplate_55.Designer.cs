...
namespace Web_test_bot.Migrations
{
    ...
    [Migration("20250409143940_Ravigatemplate_55")]
    partial class Ravigatemplate_55
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyPhoto", b =>
                {
                    ...
                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyMessage", null)
                        .WithMany("photo")
                        .HasForeignKey("MyMessageId");

                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyWorkDetales", null)
