...
namespace Web_test_bot.Migrations
{
    ...
    [Migration("20250409154925_Ravigatemplate_63")]
    partial class Ravigatemplate_63
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("MyMenuContentId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("MyWorkDetalesId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MyMenuContentId");

                    b.HasIndex("MyWorkDetalesId");
            ...
            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyWorkDetales", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("EntyCode")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("EntyName")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("MyWorkDetales");
                });

            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyWorkEnty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyPhoto", b =>
                {
                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyMessage", "ParentMessage")
                        .WithMany("photo")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyMenuContent", null)
                        .WithMany("PhotoFormMenu")
                        .HasForeignKey("MyMenuContentId");

                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyWorkDetales", "ParentDetale")
                        .WithMany("TelegramPfotoes")
                        .HasForeignKey("MyWorkDetalesId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyMessage", "ParentMenu")
                        .WithMany()
                        .HasForeignKey("ParentMenuID");

                    b.Navigation("ParentDetale");
            ...
            modelBuilder.Entity("Web_test_bot.DbTools.DbObjeckts.MyWorkDetales", b =>
                {
                    b.HasOne("Web_test_bot.DbTools.DbObjeckts.MyWorkEnty", "ParentEnt")
                        .WithMany("Items")
                        .HasForeignKey("ParenId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("ParentEnt");
                });
